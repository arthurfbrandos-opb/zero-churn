...
const TASKS: KanbanTask[] = [
  ...
  { id: 'S1-01', sprint: 's1', status: 'backlog', type: 'bloqueante',  title: 'Schema Supabase completo com RLS (isolamento por agência)', note: 'Todas as outras do sprint dependem disso' },
  { id: 'S1-02', sprint: 's1', status: 'backlog', type: 'sequencial',  title: 'Supabase Auth no Next.js — email/senha + sessão persistente' },
  { id: 'S1-03', sprint: 's1', status: 'backlog', type: 'paralelo',    title: 'Criptografia AES-256 para credenciais de integrações' },
  { id: 'S1-04', sprint: 's1', status: 'backlog', type: 'sequencial',  title: 'Middleware Next.js — proteger rotas + redirecionar para login' },
  { id: 'S1-05', sprint: 's1', status: 'backlog', type: 'sequencial',  title: 'Resend (e-mail) — configurar + template base de e-mail' },
  { id: 'S1-06', sprint: 's1', status: 'backlog', type: 'paralelo',    title: 'API Route: CRUD de agências (criar, editar, buscar perfil)' },
  { id: 'S1-07', sprint: 's1', status: 'backlog', type: 'paralelo',    title: 'API Route: CRUD de clientes (criar, editar, listar, deletar)' },
  { id: 'S1-08', sprint: 's1', status: 'backlog', type: 'sequencial',  title: 'API Route: CRUD de integrações com criptografia' },
  { id: 'S1-09', sprint: 's1', status: 'backlog', type: 'paralelo',    title: 'API Route: CRUD de form_submissions (salvar + listar por cliente)' },
  { id: 'S1-10', sprint: 's1', status: 'backlog', type: 'paralelo',    title: 'API Route: CRUD de referrals (indicações)' },
  { id: 'S1-11', sprint: 's1', status: 'backlog', type: 'sequencial',  title: 'Script de seed — popular banco com clientes realistas para testes' },
  { id: 'S1-12', sprint: 's1', status: 'backlog', type: 'sequencial',  title: 'Conectar telas do MVP ao backend real (substituir mock data pelas APIs)' },
  { id: 'S1-13', sprint: 's1', status: 'backlog', type: 'sequencial',  title: 'Tela de Onboarding funcional (salva perfil + dia do scheduler)' },
  { id: 'S1-14', sprint: 's1', status: 'backlog', type: 'sequencial',  title: 'Loading states e estados de erro em todas as telas conectadas' },
  { id: 'S1-15', sprint: 's1', status: 'backlog', type: 'independente',title: 'Teste DoD: criar conta → onboarding → cadastrar → editar → dashboard' },

  // ── SPRINT 2 — INTEGRAÇÕES ────────────────────────────────────
  { id: 'S2-01', sprint: 's2', status: 'backlog', type: 'paralelo',    title: 'Asaas: autenticar + buscar cobranças dos últimos 60 dias' },
  { id: 'S2-02', sprint: 's2', status: 'backlog', type: 'paralelo',    title: 'Asaas: validar credenciais ao salvar (erro amigável)' },
  ...
  { id: 'S2-07', sprint: 's2', status: 'backlog', type: 'sequencial',  title: 'Tratamento de erros — integração falha não trava análise inteira' },
  { id: 'S2-08', sprint: 's2', status: 'backlog', type: 'sequencial',  title: 'Status das integrações: verificar periodicamente se ainda são válidas' },
  { id: 'S2-09', sprint: 's2', status: 'backlog', type: 'sequencial',  title: 'Alerta automático quando integração expirar ou der erro persistente' },
  { id: 'S2-10', sprint: 's2', status: 'backlog', type: 'paralelo',    title: 'Formulário público real: salvar no banco + bloquear reenvio do mesmo link' },
  { id: 'S2-11', sprint: 's2', status: 'backlog', type: 'sequencial',  title: 'Detecção de não resposta: flag automático após 7 e 15 dias' },
  { id: 'S2-12', sprint: 's2', status: 'backlog', type: 'paralelo',    title: 'E-mail automático: lembrete de enviar formulário 5 dias antes da análise' },
  { id: 'S2-13', sprint: 's2', status: 'backlog', type: 'independente',title: 'Teste DoD: 1 cliente real com 3 fontes conectadas sem erro' },
