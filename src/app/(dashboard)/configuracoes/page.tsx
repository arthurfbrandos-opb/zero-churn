...
import {
  ...
  ExternalLink, Package, Wrench, Mail, Copy,
} from 'lucide-react'
...
function ProdutosSection() {
  ...
  function duplicateProduto(p: Produto) {
    const copy: Produto = {
      id: `p-${Date.now()}`,
      name: `${p.name} (Cópia)`,
              ...
              <CardContent className="p-2.5 px-3">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    {!isEditing && (
                      <button onClick={() => duplicateProduto(p)}
  ...
  return (
    <div className="space-y-2">
      ...
      <p className="text-zinc-500 text-sm mb-3">
        Conecte suas ferramentas de pagamento e e-mail transacional.
      </p>

      {/* Aviso: WhatsApp está em aba separada */}
      <div className="flex items-start gap-2 p-3 bg-emerald-500/5 border border-emerald-500/20 rounded-xl mb-3">
        <MessageCircle className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
        <div className="text-xs">
          <p className="text-emerald-300 font-medium">WhatsApp agora tem aba própria!</p>
          <p className="text-zinc-400 mt-0.5">
            Acesse a aba <strong className="text-zinc-300">WhatsApp</strong> ao lado para conectar o número da agência e vincular grupos aos clientes.
          </p>
        </div>
      </div>
